...
def generate_page(root, from_path, template_path, dest_path):
...
def generate_pages_recursive(root, dir_path_content, template_path, dest_dir_path):
    ...
    for item in dir_contents:
        ...
        if os.path.isdir(item_path):
            os.mkdir(dest_path)
            generate_pages_recursive(root, item_path, template_path, dest_path)
        else:
            generate_page(root, item_path, template_path, dest_path.replace(".md", ".html"))
